...
import { AtkButtonCard, AtkF1ExtrasCard, AtkProfileCard, AtkReceiverCard } from "./cards/AtkCards";
import {
  DebounceCard,
  EggButtonCard,
  EggCpiCard,
...
export function Workspace({
  ...
  const advanced = [
    ...
    show(has.atkF1Extras, ["advanced"]) ? <AtkF1ExtrasCard key="atk-f1-extras" snapshot={snapshot} /> : null,
